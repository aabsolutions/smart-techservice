  ...
  implements OnInit
{
  ...
  ngOnInit() {
    if (this.authService.currentUser()) {
      ...
      this.userFullName = this.authService.currentUser().fullName || '';
      this.userImg =
        './assets/images/user/' + (this.authService.currentUser().avatar || 'default.png');
      ...
      if (userRole === Role.Admin) {
        ...
        this.userType = this.capitalizeString(Role.Technician);
      } else if (userRole === Role.Receptionist) {
        this.userType = this.capitalizeString(Role.Receptionist);
