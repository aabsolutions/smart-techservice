  ...
  implements OnInit
{
  ...
  currentUserRole: Role = Role.Technician;
  ...
  ngOnInit() {
    ...
    this.currentUserRole = userRole || Role.Technician;
  ...
  updateVisibleCommands() {
    if (this.currentUserRole === Role.Technician) {
    ...
    } else if (this.currentUserRole === Role.Receptionist) {
      this.visibleCommands = [
        {
          label: '⚡ Open AI Chat Assistant',
          route: 'open_ai_chat',
